...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    TRMainViewController *mainViewController = [TRMainViewController new];
    RESideMenu *sideViewController = [[RESideMenu alloc] initWithContentViewController:mainViewController leftMenuViewController:[TRLeftViewController new] rightMenuViewController:nil];
